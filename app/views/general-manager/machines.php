  ...
  <body>
    ...
    <main id="main" class="d-flex flex-nowrap">
      ...
      <div class="w-100 d-flex flex-column p-4">
        <h4 class="font-roboto">Machines</h4>
          ...
          <table class="table table-striped table-sm">
            <thead>
              <tr>
                ...
                <th scope="col">Slice Into</th>
                <th scope="col">Slicing Time (Minutes)</th>
                <th scope="col">Blocks Sliced</th>
            ...
            <?php 
              foreach ($result as $row) {
                ...
                echo "<td>{$row['slice_into']}</td>";
                echo "<td>{$row['slicing_time']}</td>";
                echo "<td>{$row['blocks_sliced']}</td>";
